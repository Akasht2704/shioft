...
const services = [
  {
    ...
    icon: <FaLaptopCode className="text-5xl text-blue-600 mb-4 animate-spin-slow" />,
  },
  {
    title: 'Mobile Apps',
    description: 'Cross-platform apps for Android & iOS.',
    icon: <FaMobileAlt className="text-5xl text-green-600 mb-4 animate-spin-slow" />,
  },
  {
    title: 'Cloud Solutions',
    description: 'Scalable and cost-effective cloud architecture.',
    icon: <FaCloud className="text-5xl text-purple-600 mb-4 animate-spin-slow" />,
  },
]
    ...
    <section className="bg-gray-100 py-16 px-4" id="services">
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {services.map((service, idx) => (
          <div key={idx} className="bg-white p-6 shadow rounded-lg text-center">
